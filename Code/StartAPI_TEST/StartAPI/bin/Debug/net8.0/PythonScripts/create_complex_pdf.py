...
template = template_env.get_template("./PythonScripts/basic_template.html")
...
pdfkit.from_string(output_text, "./PythonScripts/output.pdf", configuration=config, css=r"./PythonScripts/styles.css")
